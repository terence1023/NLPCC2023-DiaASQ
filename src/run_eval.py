...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--pred_file', default='data/save/pred_en_valid_baseline.json', type=str, required=False, help='pred file name with directory name')
    parser.add_argument('-g', '--gold_file', default='data/dataset/jsons_en/valid.json', type=str, required=False, help='gold file name with directory name')
